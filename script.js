...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showWalletModal() {
        ...
        // Add animation
        setTimeout(() => {
            walletModal.querySelector('.modal-content').style.transform = 'translate(-50%, -50%) scale(1)';
            walletModal.querySelector('.modal-content').style.opacity = '1';
        }, 10);
    }

    function hideWalletModal() {
        walletModal.querySelector('.modal-content').style.transform = 'translate(-50%, -50%) scale(0.9)';
    ...
    const animateElements = document.querySelectorAll('.feature-card, .market-card, .roadmap-item, .stat-card');
    ...
    function animateCounters() {
        ...
        counters.forEach(counter => {
            ...
            if (isNumber) {
                ...
                const suffix = target.includes('%') ? '%' : target.includes('K') ? 'K' : target.includes('M') ? 'M' : '';
