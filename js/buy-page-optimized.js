...
class BuyPageOptimized {
  ...
  setupEventListeners() {
    ...
    if (amountInput) {
      ...
      amountInput.addEventListener('focus', () => this.handleInputFocus(amountInput));
      amountInput.addEventListener('blur', () => this.handleInputBlur(amountInput));
    }
  ...
  initializeAnimations() {
    ...
    document.querySelectorAll('.stat-item, .payment-card, .security-item, .faq-item').forEach(el => {
      observer.observe(el);
    });
  ...
  animateHeroElements() {
    const heroElements = document.querySelectorAll('.hero-badge, .buy-hero-title, .buy-hero-subtitle, .hero-stats, .hero-actions');
  ...
  setupRecentPurchases() {
    ...
    if (purchasesList) {
      const samplePurchases = [
        { name: 'John D.', amount: '$1,500', tokens: '1,500 GOO', time: '2 min ago' },
        { name: 'Sarah M.', amount: '$500', tokens: '500 GOO', time: '5 min ago' },
        { name: 'Mike R.', amount: '$2,000', tokens: '2,000 GOO', time: '8 min ago' },
        { name: 'Lisa K.', amount: '$750', tokens: '750 GOO', time: '12 min ago' }
      ];
