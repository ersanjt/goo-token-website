...
class WhitepaperEnhanced {
  ...
  setupScrollAnimations() {
    ...
    const sections = document.querySelectorAll('.whitepaper-section-content, .problem-item, .feature-card, .roadmap-item');
  ...
  setupDownloadFunctionality() {
    window.downloadPDF = () => {
      ...
      setTimeout(() => {
        ...
        this.downloadFile(content, 'goo-token-whitepaper.pdf', 'application/pdf');
    ...
    window.downloadDoc = () => {
      ...
      setTimeout(() => {
        ...
        this.downloadFile(content, 'goo-token-whitepaper.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document');
