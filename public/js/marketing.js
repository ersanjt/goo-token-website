...
class MarketingDashboard {
  ...
  getInitiativeDetails(initiativeTitle) {
    const details = {
      'Developer Program': {
        description:
          'Join our developer program and build innovative applications on the Goo Token ecosystem.',
        benefits: [
      ...
      'Education Program': {
        description:
          'Learn blockchain technology through our comprehensive education program.',
        benefits: [
          'Free online courses',
          'Expert-led webinars',
      ...
      'Social Impact': {
        description:
          'Make a positive impact on society through our social impact initiatives.',
        benefits: [
  ...
  handleMaterialDownload(materialTitle) {
    ...
    setTimeout(() => {
      this.showNotification(
        `${materialTitle} downloaded successfully!`,
        'success'
      );
    }, 2000);
  }
